export const spanishMessages = {
  ra: {
    ...
    message: {
      ...
      auth_error: "No se pudo iniciar sesión, por favor intente nuevamente",
      bulk_delete_content:
      ...
      clear_array_input:
        "¿Estás seguro que deseas eliminar todos los elementos?",
      delete_content: "¿Estás seguro que deseas eliminar este elemento?",
      delete_title: "Eliminar %{name} #%{id}",
      details: "Detalles",
      error: "Ha ocurrido un error y tu solicitud no se ha completado.",
    ...
    navigation: {
      ...
      page_out_of_boundaries:
        "La página número %{page} está fuera de los límites",
    ...
    notification: {
      ...
      i18n_error: "No se pudo cargar la traducción para el idioma especificado",
    ...
    saved_queries: {
      ...
      remove_message: "¿Estás seguro que deseas eliminar este filtro guardado?",
